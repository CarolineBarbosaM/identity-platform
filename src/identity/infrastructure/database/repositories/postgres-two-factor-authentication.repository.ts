...
@Injectable()
export class PostgresTwoFactorAuthenticationRepository
  implements TwoFactorAuthenticationRepository
{
  ...
  async save(
    ...
    await this.repository.save({
      ...
      userId:
        twoFactorAuthentication.getUserId(),
      secret:
        twoFactorAuthentication.getSecret(),
      createdAt:
        twoFactorAuthentication.getCreatedAt(),
      enabledAt:
        twoFactorAuthentication.getEnabledAt(),
    });
  }
}
